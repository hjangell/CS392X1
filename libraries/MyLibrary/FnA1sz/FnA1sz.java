...
//    
	...
	public final FnA1szSUtil U0 = new FnA1szSUtil();
//
...
//
	// Professor Xi's implementation does not work
    //public FnA1sz<T> mergeSort(ToIntBiFunction<T,T> cmp) { return this.U0.mergeSort(this, cmp); }
//
	// Professor Xi's implementation does not work
    //public FnA1sz<T> insertSort(ToIntBiFunction<T,T> cmp) { return this.U0.insertSort(this, cmp); }
