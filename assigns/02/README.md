...
It is due Tuesday, the 3rd of February, 2026
...
Please determine whether there exist DISTINCT indices i and j and k
satisfying A[i] + A[j] = A[k].  Design a soft quadratic (that is, $tO(n^2),
where $tQ$ is for the "soft" big O) algorithm for the problem and then implement it!
